		...
		<main>
			...
			<section className=' p-8 flex flex-col gap-y-4'>
				...
				<p className='my-4 pr-4 max-w-2/3 leading-6 text-gray-700'>
					...
					React, but I'm also comfortable working with back-end technologies
					like Node.js. I'm always learning and exploring new technologies to
					improve my skills and deliver the best possible results for my
					clients.
				</p>
			...
			<section className=' p-8 flex flex-col gap-y-4'>
				...
				<p className='my-4 pr-4 max-w-2/3 leading-6 text-gray-700'>
					...
					reach out if you have a project in mind or just want to chat about web
					development.
				</p>
